...
export const commentConfig: CommentConfig = {
	...
	//giscus评论系统配置（已切换为用户自己的仓库 personal-website）
	giscus: {
		// 设置 Giscus 评论系统仓库
		repo: "Muhammad-repos/personal-website",
		// 设置 Giscus 评论系统仓库ID
		repoId: "R_kgDOTVln1g",
		// 设置 Giscus 评论系统分类
		category: "General",
		// 获取 Giscus 评论系统分类ID
		categoryId: "DIC_kwDOTVln1s4DBApZ",
		// 获取 Giscus 评论系统映射方式（说说逐条评论在 moments.ts 中强制覆盖为 specific + term=moment-<id>）
		mapping: "specific",
		// 获取 Giscus 评论系统严格模式
		strict: "0",
		// 获取 Giscus 评论系统反应功能
