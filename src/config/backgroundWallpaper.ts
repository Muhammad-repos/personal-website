...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	// 改为 none：使用自托管的 Apple 风格极光渐变背景（glass.css 中实现），不依赖远程随机图，毛玻璃质感稳定统一。
	mode: "none",
	// 是否允许用户通过导航栏切换壁纸模式
	...
	src: {
		// 桌面背景图片（支持单张或多张随机）
		// 改为本地自托管图（src/assets/images/DesktopWallpaper/ 下），
		// 由 Astro 在构建期自动优化(webp/avif)+LQIP 占位，走 Cloudflare CDN。
		// 优势：1) 不再依赖外部图床，部署到 CF 后无白屏/超时风险
		//       2) 图片加载前有 LQIP 渐变占位，不会闪白
		//       3) 相对路径写法让 Astro 自动压缩，体积远小于原图
		// 注意：必须用相对路径(不以/开头)，不要写远程URL或/public路径，否则无优化且无LQIP
		desktop: [
			"assets/images/DesktopWallpaper/landscape-01.jpg",
			"assets/images/DesktopWallpaper/landscape-04.jpg",
			"assets/images/DesktopWallpaper/landscape-11.jpg",
			"assets/images/DesktopWallpaper/landscape-13.jpg",
			"assets/images/DesktopWallpaper/landscape-20.jpg",
			"assets/images/DesktopWallpaper/nature-04.jpg",
			"assets/images/DesktopWallpaper/nature-05.jpg",
			"assets/images/DesktopWallpaper/nature-08.jpg",
			"assets/images/DesktopWallpaper/nature-14.jpg",
			"assets/images/DesktopWallpaper/portrait-03.jpg",
			"assets/images/DesktopWallpaper/portrait-16.jpg",
		],
		// 移动背景图片（支持单张或多张随机）
