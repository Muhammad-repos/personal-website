...
**解释**
+ 当 d ``->`` 0 时，称其为渐近线；
	+ ![Pasted image 20240115194536](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240115194536.png)
...
+ 解析
	...
	+ 5. 画图
		...
		+ ![Pasted image 20240115201603](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240115201603.png)
+ 题型： #函数图形绘制
...
+ 推断：
	+ 斜渐近线和函数的关系：当 x `->` 无穷时，$y=f(x)$ 和 $y=ax+b$ 的距离趋于零；
		+ ![Pasted image 20240326174937](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240326174937.png)
