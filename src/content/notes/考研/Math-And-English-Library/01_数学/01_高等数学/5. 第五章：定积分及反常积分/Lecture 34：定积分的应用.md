...
+ 分析
	+ ![Pasted image 20240131142232](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240131142232.png)
	+ 可以对 x 积分
	+ 也可以对 y 积分
+ 解析 1：对 x 积分
	+ 第一步：找范围
		+ ![Pasted image 20240131142306](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240131142306.png)
	+ 第二部：找微元
		+ x 和 x+dx
		+ ![Pasted image 20240131142332](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240131142332.png)
	+ 第三步：积分
		+ 从 0-1 积分
...
+ 分析
	...
	+ 第一步：它的范围；是 ![Pasted image 20240131150018](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240131150018.png)
	+ 第二步：求它在微小的区间上，对应图形如何求出对应面积：
		+ ![Pasted image 20240131150049](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240131150049.png)
		+ 可以近似看出一个扇形；
		+ 微元：
			+ ![Pasted image 20240131150113](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240131150113.png)
	+ 第三步：求积分
		+ ![Pasted image 20240131150129](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240131150129.png)
+ 解析
	+ 第一步：确定范围
		+ 可以先画图 -> 画图需要先画一些**特殊点**；
		+ ![Pasted image 20240131150311](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240131150311.png)
		+ 因为 conx 的特点；
		+ 确定范围：为 0 到 Π
			+ 因为下面一半和上面一半一样，因此只需要求上面一半然后乘以 2 即可；
			+ ![Pasted image 20240131150353](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240131150353.png)
			+ ![Pasted image 20240131150416](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240131150416.png)
	+ 第三步：求解定积分
		+ ![Pasted image 20240131150658](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240131150658.png)
		+ 因为直接求 conx 在 0 到 PI 上无法求出，但求 0 到二分之 PI 上很简单，因此进行定积分代换：
			+ 设：
			+ ![Pasted image 20240131150652](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240131150652.png)
		+ 因此：
			+ ![Pasted image 20240131150832](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240131150832.png)
+ 题型： #定积分的几何应用 
...
**图示**
+ 图示：绕 X 轴旋转
	+ ![Pasted image 20240131151121](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240131151121.png)
...
+ 分析  
	+ 椭圆的图形
		+ 只需要计算上面的一半就可以了；
		+ 不止，只需要计算四分之一部分就可以了；
		+ ![Pasted image 20240131152357](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240131152357.png)
+ 解析
	+ 由原式得 y 的公式：
		+ ![Pasted image 20240131152437](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240131152437.png)
	+ 由体积公式可知：
		+ $V_{x}=\pi\int_{a}^{b}f^{2}(x)\operatorname{d}x$
	+ 且，因为只需要求四分之一
		+ 因此只需要求 $[0,a]$ 范围上，它旋转的面积
	+ 因此，带入可得：
		+ ![Pasted image 20240131152648](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240131152648.png)
+ 题型： #定积分的几何应用 
...
+ 解析：求 X 
	+ 求求旋转体的体积公式可知：
		...
		+ ![Pasted image 20240131153411](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240131153411.png)
	+ 继续求解，其中令 u=t/2
		+ ![Pasted image 20240131153609](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240131153609.png)
+ 题型： #定积分的几何应用 
...
+ $s_n=\sum_{i=1}^n\left\|\overline{M_{i-1}M_i}\right\|$
	+ ![Pasted image 20240131160512](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240131160512.png)
	+ 很多个小段线段的求和
...
+ 分析
	+ 这种题是第二种形式：
		+ ![Pasted image 20240131162204](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240131162204.png)
+ 解析
	+ 将函数带入：
	+ ![Pasted image 20240131162350](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240131162350.png)
+ 题型： #定积分的几何应用 
...
**解释**  
+ 图示： 
	+ ![Pasted image 20240415204510](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240415204510.png)
...
+ 图示：
	+ ![Pasted image 20240415213032](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240415213032.png)
+ 解析：第一问
...
+ 图示：
	+ ![Pasted image 20240415215603](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240415215603.png)
+ 分析：
	+ 深度的微小变化：
		+ 压强：p=gρ(h+1-y)
		+ 压力：p=gρ(h+1-y) 2 dy
