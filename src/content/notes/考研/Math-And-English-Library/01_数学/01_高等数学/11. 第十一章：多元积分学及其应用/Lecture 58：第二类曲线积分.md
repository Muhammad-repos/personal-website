...
### 28.4.2 斯罗克斯公式
##### **定理**： #斯托克斯公式 
> <font color="#8db3e2"><font color="#c6d9f0">描述：</font></font> $$\int_{L}P(x,y,z)\mathrm{d}x+Q(x,y,z)\mathrm{d}y+R(x,y,z)dz=$$![Pasted image 20240521214413](/notes-assets/%E8%80%83%E7%A0%94/Pasted%20image%2020240521214413_1.png)
